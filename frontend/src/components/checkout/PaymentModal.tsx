    ...
    >
      <div className="bg-background rounded-xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
        ...
        <div className="p-6 space-y-5">
          {/* Receipt preview */}
          <div className="bg-muted/40 rounded-lg p-4 text-sm font-mono space-y-1 max-h-40 overflow-y-auto">
            ...
            {discountPaise > 0 && (
              <div className="flex justify-between text-green-600 pt-1 border-t border-dashed">
                <span>Discount</span>
